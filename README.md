# 🌿 Eco-Sense: AI-Powered Wildlife Monitoring System

> **An AI-powered wildlife monitoring system that leverages Computer Vision and Deep Learning to detect wildlife and potential threats in real time, supporting smarter conservation and forest surveillance.**
...
| AI & Deep Learning | YOLOv5, CNN, PyTorch |
| Computer Vision | OpenCV |
| Backend | Flask |
| Frontend | HTML, CSS, JavaScript |
| Data Processing | NumPy, Pandas |
| Data Visualization | Matplotlib |
| Dataset Sources | Kaggle, Roboflow |
...
- Drone and smart camera integration
...
Read more about the inspiration and development journey behind **Eco-Sense** in my LinkedIn post:

🔗 **LinkedIn:**  
https://www.linkedin.com/posts/vrushikakpanchal_aiforgood-wildlifemonitoring-yolov5-activity-7331989490011377664-EQUc
